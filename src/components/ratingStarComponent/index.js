...
//   const source = filled ? images.star_fulfil_icon : images.star_icon1;
//   return (
...
const RatingStatComponent = ({value = 0, onRatingChange}) => {
  ...
  return (
    <SafeAreaView>
      <StarRating rating={selected} onChange={handleChange} />
    </SafeAreaView>
  );
};
